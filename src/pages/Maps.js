...
const Maps = () => (
  <Main title="Maps" description="Learn about Pablo Hernandez Borges's maps.">
    <article className="post" id="maps">
      ...
      <p>
        My cartographic journey began with{' '}
        <a href="https://www.esri.com/en-us/arcgis/products/arcgis-pro/overview">
          ArcGIS Pro
        </a>, a powerful tool for transforming raw geospatial data into compelling visual stories.{' '}
        These maps highlight my ability to analyze complex datasets, from satellite imagery to{' '}
        demographic layers, revealing hidden patterns in landscapes and societies. Whether mapping{' '}
        vegetation health with NDVI indices or creating 3D relief models of rugged terrains, each{' '}
        project pushed the boundaries of design and functionality, blending science with artistry to{' '}
        communicate insights that drive informed decisions.
      </p>
      <p>
      ...
      <p>
        ...
        <a href="https://www.esri.com/en-us/arcgis/products/arcgis-pro/overview">
          ArcGIS Pro
        </a>, I&apos;ve honed skills in geoprocessing, symbology, and layout design, ensuring every map is not just{' '}
        accurate but also intuitive and engaging. This foundation ignited my passion for spatial storytelling,{' '}
        inspiring me to explore how maps can bridge data and human experience.
      </p>
      <h3>
      ...
      <p>
        ...
        <a href="https://earthengine.google.com/">Google Earth Engine</a> (GEE), I harness petabytes of{' '}
        satellite imagery (Landsat, Sentinel, MODIS) to monitor environmental change over decades. By writing{' '}
        custom JavaScript API scripts, I bypass the limitations of local hardware to perform multi-spectral{' '}
        analysis, land-cover classification, and time-series monitoring at a global scale.
      </p>
      <p>
        <SlideshowLightbox className="images" showThumbnails theme="lightbox">
